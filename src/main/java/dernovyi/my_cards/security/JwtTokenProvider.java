package dernovyi.my_cards.security;
...
import static dernovyi.my_cards.constant.SecurityConstant.*;
...
public class JwtTokenProvider {
    ...
    public String generateJwtToken(UserPrincipal userPrincipal) {
        ...
        return JWT.create()
                .withIssuer(ADMINISTRATION)//comp name
                .withAudience(ADMINISTRATION)//admin people
    ...
    private JWTVerifier getJwtVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(ADMINISTRATION).build();
